...
import openfl.utils.Float32Array;
    ...
    class Mesh extends AbstractMesh implements IGetSetVerticesData {
        ...
        static function CreateBox(name:String, size:Float, scene:Scene, ?updatable:Bool ) : Mesh {
        ...
        static function CreateSphere(name:String, segments:Float, diameter:Float, scene:Scene, ?updatable:Bool ) : Mesh {
        ...
        static function CreateTorusKnot(name:String, radius:Float, tube:Float, radialSegments:Float, tubularSegments:Float,  p:Float ,q:Float, scene:Scene, ?updatable:Bool ) : Mesh {
        ...
        static function CreatePlane(name:String, size:Float, scene:Scene, ?updatable:Bool ) : Mesh {
        ...
        static function CreateGroundFromHeightMap(name:String, url:String, width:Float, height:Float, subdivisions:Float, minHeight:Float, maxHeight:Float, scene:Scene, ?updatable:Bool ) : Mesh {
          //Todo
          trace('todo');
        ...
        static function MinMax(meshes:Array<AbstractMesh>):Dynamic {
            //var min : Vector3;
            //var max : Vector3;
            var _MinMax:Dynamic;
            var minVector:Vector3;
            var maxVector:Vector3;
            // haxe does not support for loops with C/JS syntaxt ... unfolding : 
            //  for (var i in meshes)
            for( i in meshes){
                var mesh = meshes[i];
        ...
        static function Center(meshesOrMinMaxVector) : Vector3 {
