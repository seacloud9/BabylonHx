...
class Octree {
	...
	public function update(worldMin:Vector3, worldMax:Vector3, meshes:Array<AbstractMesh>) {
	...
	public static function _CreateBlocks(worldMin:Vector3, worldMax:Vector3, meshes:Array<AbstractMesh>, maxBlockCapacity:Int, target:Dynamic) {
        target.blocks = [];
