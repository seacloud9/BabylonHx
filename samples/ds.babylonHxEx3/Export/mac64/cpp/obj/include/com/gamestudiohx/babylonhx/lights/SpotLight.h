...
#define INCLUDED_com_gamestudiohx_babylonhx_lights_SpotLight
...
HX_DECLARE_CLASS4(com,gamestudiohx,babylonhx,lights,SpotLight)
...
class HXCPP_CLASS_ATTRIBUTES  SpotLight_obj : public ::com::gamestudiohx::babylonhx::lights::Light_obj{
	public:
		typedef ::com::gamestudiohx::babylonhx::lights::Light_obj super;
		typedef SpotLight_obj OBJ_;
		SpotLight_obj();
		Void __construct(::String name,::com::gamestudiohx::babylonhx::tools::math::Vector3 position,::com::gamestudiohx::babylonhx::tools::math::Vector3 direction,Float angle,Float exponent,::com::gamestudiohx::babylonhx::Scene scene);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< SpotLight_obj > __new(::String name,::com::gamestudiohx::babylonhx::tools::math::Vector3 position,::com::gamestudiohx::babylonhx::tools::math::Vector3 direction,Float angle,Float exponent,::com::gamestudiohx::babylonhx::Scene scene);
		...
		::String __ToString() const { return HX_CSTRING("SpotLight"); }
...
#endif /* INCLUDED_com_gamestudiohx_babylonhx_lights_SpotLight */ 
