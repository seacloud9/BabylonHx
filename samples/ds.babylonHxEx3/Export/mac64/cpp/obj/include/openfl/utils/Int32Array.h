...
#define INCLUDED_openfl_utils_Int32Array
...
HX_DECLARE_CLASS2(openfl,utils,Int32Array)
namespace openfl{
namespace utils{


class HXCPP_CLASS_ATTRIBUTES  Int32Array_obj : public ::openfl::utils::ArrayBufferView_obj{
	public:
...
#endif /* INCLUDED_openfl_utils_Int32Array */ 
