	...
	HX_STACK_ARG(doNotCloneChildren,"doNotCloneChildren")
{
		...
		HX_STACK_LINE(713)
		::haxe::Log_obj::trace(HX_CSTRING("clone -- hit"),hx::SourceInfo(HX_CSTRING("Mesh.hx"),713,HX_CSTRING("com.gamestudiohx.babylonhx.mesh.Mesh"),HX_CSTRING("clone")));
		HX_STACK_LINE(714)
			...
			HX_STACK_LINE(754)
			{
				...
				struct _Function_3_1{
					inline static bool Block( ::com::gamestudiohx::babylonhx::mesh::Mesh &resultMesh){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/mesh/Mesh.hx",754,0xf4cec482)
						{
							HX_STACK_LINE(754)
...
bool doNotRecurse = __o_doNotRecurse.Default(false);
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.Mesh","dispose",0xc03244ed,"com.gamestudiohx.babylonhx.mesh.Mesh.dispose","com/gamestudiohx/babylonhx/mesh/Mesh.hx",761,0xf4cec482)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.Mesh","convertToFlatShadedMesh",0xbc95c8f9,"com.gamestudiohx.babylonhx.mesh.Mesh.convertToFlatShadedMesh","com/gamestudiohx/babylonhx/mesh/Mesh.hx",783,0xf4cec482)
		HX_STACK_THIS(this)
		HX_STACK_LINE(787)
