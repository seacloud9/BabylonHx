...
Void FreeCamera_obj::_collideWithWorld( ::com::gamestudiohx::babylonhx::tools::math::Vector3 velocity){
{
												...
												HX_STACK_LINE(331)
												{
													...
													struct _Function_12_1{
														inline static bool Block( ::com::gamestudiohx::babylonhx::mesh::SubMesh &subMesh,::com::gamestudiohx::babylonhx::tools::math::Matrix &transformMatrix){
															HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",331,0x57a6a279)
															{
																HX_STACK_LINE(331)
		...
		HX_STACK_LINE(334)
		{
			...
			HX_STACK_LINE(334)
			_g3 = ::Math_obj::sqrt((((_this->x * _this->x) + (_this->y * _this->y)) + (_this->z * _this->z)));
		}
		HX_STACK_LINE(334)
		if (((_g3 > ::com::gamestudiohx::babylonhx::Engine_obj::collisionsEpsilon))){
			HX_STACK_LINE(335)
			{
				HX_STACK_LINE(335)
				::com::gamestudiohx::babylonhx::tools::math::Vector3 _this = this->position;		HX_STACK_VAR(_this,"_this");
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.cameras.FreeCamera","_checkInputs",0x3dcf12dd,"com.gamestudiohx.babylonhx.cameras.FreeCamera._checkInputs","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",342,0x57a6a279)
		HX_STACK_THIS(this)
		HX_STACK_LINE(343)
					...
					HX_STACK_LINE(363)
					{
						...
						struct _Function_5_1{
							inline static bool Block( hx::ObjectPtr< ::com::gamestudiohx::babylonhx::cameras::FreeCamera_obj > __this){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",363,0x57a6a279)
								{
									HX_STACK_LINE(363)
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.cameras.FreeCamera","_update",0xf87ffebd,"com.gamestudiohx.babylonhx.cameras.FreeCamera._update","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",369,0x57a6a279)
		HX_STACK_THIS(this)
		HX_STACK_LINE(370)
		{
			HX_STACK_LINE(370)
		...
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::com::gamestudiohx::babylonhx::cameras::FreeCamera_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",372,0x57a6a279)
				{
					HX_STACK_LINE(372)
			...
			if (((bool(this->checkCollisions) && bool(this->_scene->collisionsEnabled)))){
				HX_STACK_LINE(378)
				{
							...
							if (((collider->retry >= (int)3))){
														...
														while((true)){
															...
															HX_STACK_LINE(378)
															{
																...
																struct _Function_15_1{
																	inline static bool Block( ::com::gamestudiohx::babylonhx::mesh::SubMesh &subMesh,::com::gamestudiohx::babylonhx::tools::math::Matrix &transformMatrix){
																		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",378,0x57a6a279)
																		{
																			HX_STACK_LINE(378)
																			::com::gamestudiohx::babylonhx::tools::math::Matrix _this1 = subMesh->_lastColliderTransformMatrix;		HX_STACK_VAR(_this1,"_this1");
																			HX_STACK_LINE(378)
																...
																if (((bool((subMesh->_lastColliderWorldVertices == null())) || bool(!(_Function_15_1::Block(subMesh,transformMatrix)))))){
																	...
																	HX_STACK_LINE(378)
																	{
																		...
																		while((true)){
																			...
																			int i = (_g3)++;		HX_STACK_VAR(i,"i");
																			HX_STACK_LINE(378)
																			::com::gamestudiohx::babylonhx::tools::math::Vector3 _g19;		HX_STACK_VAR(_g19,"_g19");
																			HX_STACK_LINE(378)
																			{
																				HX_STACK_LINE(378)
																				::com::gamestudiohx::babylonhx::tools::math::Vector3 vector = mesh->_positions->__get(i).StaticCast< ::com::gamestudiohx::babylonhx::tools::math::Vector3 >();		HX_STACK_VAR(vector,"vector");
																			...
																			HX_STACK_LINE(378)
																			subMesh->_lastColliderWorldVertices->push(_g19);
																		}
																	}
																}
																HX_STACK_LINE(378)
								...
								if ((!(collider->collisionFound))){
									...
									if (((bool((bool((velocity1->x != (int)0)) || bool((velocity1->y != (int)0)))) || bool((velocity1->z != (int)0))))){
										...
										{
											HX_STACK_LINE(378)
											Float _g20 = ::Math_obj::sqrt((((velocity1->x * velocity1->x) + (velocity1->y * velocity1->y)) + (velocity1->z * velocity1->z)));		HX_STACK_VAR(_g20,"_g20");
											HX_STACK_LINE(378)
											Float scale = (Float(collider->nearestDistance) / Float(_g20));		HX_STACK_VAR(scale,"scale");
											HX_STACK_LINE(378)
											hx::MultEq(velocity1->x,scale);
											HX_STACK_LINE(378)
											hx::MultEq(velocity1->y,scale);
					...
					HX_STACK_LINE(378)
					{
						...
						::com::gamestudiohx::babylonhx::tools::math::Vector3 _this = this->_diffPosition;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(378)
						_g22 = ::Math_obj::sqrt((((_this->x * _this->x) + (_this->y * _this->y)) + (_this->z * _this->z)));
					}
					HX_STACK_LINE(378)
					if (((_g22 > ::com::gamestudiohx::babylonhx::Engine_obj::collisionsEpsilon))){
						HX_STACK_LINE(378)
						{
							HX_STACK_LINE(378)
							::com::gamestudiohx::babylonhx::tools::math::Vector3 _this = this->position;		HX_STACK_VAR(_this,"_this");
				...
				if ((this->applyGravity)){
					...
					HX_STACK_LINE(382)
					{
								...
								if (((collider->retry >= (int)3))){
															...
															while((true)){
																...
																HX_STACK_LINE(382)
																{
																	...
																	struct _Function_16_1{
																		inline static bool Block( ::com::gamestudiohx::babylonhx::mesh::SubMesh &subMesh,::com::gamestudiohx::babylonhx::tools::math::Matrix &transformMatrix){
																			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",382,0x57a6a279)
																			{
																				HX_STACK_LINE(382)
																				::com::gamestudiohx::babylonhx::tools::math::Matrix _this1 = subMesh->_lastColliderTransformMatrix;		HX_STACK_VAR(_this1,"_this1");
																				HX_STACK_LINE(382)
																	...
																	if (((bool((subMesh->_lastColliderWorldVertices == null())) || bool(!(_Function_16_1::Block(subMesh,transformMatrix)))))){
																		...
																		HX_STACK_LINE(382)
																		{
																			...
																			while((true)){
																				...
																				int i = (_g3)++;		HX_STACK_VAR(i,"i");
																				HX_STACK_LINE(382)
																				::com::gamestudiohx::babylonhx::tools::math::Vector3 _g23;		HX_STACK_VAR(_g23,"_g23");
																				HX_STACK_LINE(382)
																				{
																					HX_STACK_LINE(382)
																					::com::gamestudiohx::babylonhx::tools::math::Vector3 vector = mesh->_positions->__get(i).StaticCast< ::com::gamestudiohx::babylonhx::tools::math::Vector3 >();		HX_STACK_VAR(vector,"vector");
																				...
																				HX_STACK_LINE(382)
																				subMesh->_lastColliderWorldVertices->push(_g23);
																			}
																		}
																	}
																	HX_STACK_LINE(382)
									...
									if ((!(collider->collisionFound))){
										...
										if (((bool((bool((velocity1->x != (int)0)) || bool((velocity1->y != (int)0)))) || bool((velocity1->z != (int)0))))){
											...
											{
												HX_STACK_LINE(382)
												Float _g24 = ::Math_obj::sqrt((((velocity1->x * velocity1->x) + (velocity1->y * velocity1->y)) + (velocity1->z * velocity1->z)));		HX_STACK_VAR(_g24,"_g24");
												HX_STACK_LINE(382)
												Float scale = (Float(collider->nearestDistance) / Float(_g24));		HX_STACK_VAR(scale,"scale");
												HX_STACK_LINE(382)
												hx::MultEq(velocity1->x,scale);
												HX_STACK_LINE(382)
												hx::MultEq(velocity1->y,scale);
										...
										HX_STACK_LINE(382)
										Float _g25 = ::Math_obj::sqrt((((velocity1->x * velocity1->x) + (velocity1->y * velocity1->y)) + (velocity1->z * velocity1->z)));		HX_STACK_VAR(_g25,"_g25");
										HX_STACK_LINE(382)
										if (((_g25 <= closeDistance))){
											HX_STACK_LINE(382)
											finalPosition->x = position1->x;
											HX_STACK_LINE(382)
											finalPosition->y = position1->y;
						...
						HX_STACK_LINE(382)
						{
							...
							::com::gamestudiohx::babylonhx::tools::math::Vector3 _this = this->_diffPosition;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(382)
							_g26 = ::Math_obj::sqrt((((_this->x * _this->x) + (_this->y * _this->y)) + (_this->z * _this->z)));
						}
						HX_STACK_LINE(382)
						if (((_g26 > ::com::gamestudiohx::babylonhx::Engine_obj::collisionsEpsilon))){
							HX_STACK_LINE(382)
							{
								HX_STACK_LINE(382)
								::com::gamestudiohx::babylonhx::tools::math::Vector3 _this = this->position;		HX_STACK_VAR(_this,"_this");
					...
					struct _Function_4_1{
						inline static Float Block( hx::ObjectPtr< ::com::gamestudiohx::babylonhx::cameras::FreeCamera_obj > __this,::com::gamestudiohx::babylonhx::tools::math::Vector3 &oldPosition){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",383,0x57a6a279)
							{
								HX_STACK_LINE(383)
		...
		if ((needToMove)){
			HX_STACK_LINE(407)
			Float _g27 = ::Math_obj::abs(this->cameraDirection->x);		HX_STACK_VAR(_g27,"_g27");
			HX_STACK_LINE(407)
			if (((_g27 < ::com::gamestudiohx::babylonhx::Engine_obj::epsilon))){
				HX_STACK_LINE(408)
				this->cameraDirection->x = (int)0;
			}
			HX_STACK_LINE(410)
			Float _g28 = ::Math_obj::abs(this->cameraDirection->y);		HX_STACK_VAR(_g28,"_g28");
			HX_STACK_LINE(410)
			if (((_g28 < ::com::gamestudiohx::babylonhx::Engine_obj::epsilon))){
				HX_STACK_LINE(411)
				this->cameraDirection->y = (int)0;
			}
			HX_STACK_LINE(413)
			Float _g29 = ::Math_obj::abs(this->cameraDirection->z);		HX_STACK_VAR(_g29,"_g29");
			HX_STACK_LINE(413)
		...
		if ((needToRotate)){
			HX_STACK_LINE(419)
			Float _g30 = ::Math_obj::abs(this->cameraRotation->x);		HX_STACK_VAR(_g30,"_g30");
			HX_STACK_LINE(419)
			...
			HX_STACK_LINE(422)
			Float _g31 = ::Math_obj::abs(this->cameraRotation->y);		HX_STACK_VAR(_g31,"_g31");
			HX_STACK_LINE(422)
...
::com::gamestudiohx::babylonhx::tools::math::Matrix FreeCamera_obj::_getViewMatrix( ){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.cameras.FreeCamera","_getViewMatrix",0x48445888,"com.gamestudiohx.babylonhx.cameras.FreeCamera._getViewMatrix","com/gamestudiohx/babylonhx/cameras/FreeCamera.hx",429,0x57a6a279)
	HX_STACK_THIS(this)
	HX_STACK_LINE(430)
	{
		HX_STACK_LINE(430)
