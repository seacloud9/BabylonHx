...
{
HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","new",0x72b4b610,"com.gamestudiohx.babylonhx.mesh.SubMesh.new","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",44,0x2e02d060)
HX_STACK_THIS(this)
...
bool createBoundingBox = __o_createBoundingBox.Default(true);
{
	HX_STACK_LINE(45)
	this->_mesh = mesh;
	HX_STACK_LINE(47)
			...
			HX_STACK_LINE(59)
			{
				...
				struct _Function_4_1{
					inline static Dynamic Block( ::com::gamestudiohx::babylonhx::tools::math::Vector3 &minimum,::com::gamestudiohx::babylonhx::tools::math::Vector3 &maximum){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",59,0x2e02d060)
						{
...
::com::gamestudiohx::babylonhx::mesh::Mesh SubMesh_obj::getRenderingMesh( ){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","getRenderingMesh",0x9821dd33,"com.gamestudiohx.babylonhx.mesh.SubMesh.getRenderingMesh","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",63,0x2e02d060)
	HX_STACK_THIS(this)
	HX_STACK_LINE(63)
...
::com::gamestudiohx::babylonhx::culling::BoundingInfo SubMesh_obj::getBoundingInfo( ){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","getBoundingInfo",0x3b7f8158,"com.gamestudiohx.babylonhx.mesh.SubMesh.getBoundingInfo","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",67,0x2e02d060)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
...
::com::gamestudiohx::babylonhx::mesh::AbstractMesh SubMesh_obj::getMesh( ){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","getMesh",0x56997753,"com.gamestudiohx.babylonhx.mesh.SubMesh.getMesh","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",71,0x2e02d060)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
	return this->_mesh;
}
...
Dynamic SubMesh_obj::getMaterial( ){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","getMaterial",0xe1df350d,"com.gamestudiohx.babylonhx.mesh.SubMesh.getMaterial","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",74,0x2e02d060)
	HX_STACK_THIS(this)
	HX_STACK_LINE(75)
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","refreshBoundingInfo",0x81b5c61d,"com.gamestudiohx.babylonhx.mesh.SubMesh.refreshBoundingInfo","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",88,0x2e02d060)
		HX_STACK_THIS(this)
		HX_STACK_LINE(89)
		Array< Float > data = this->_renderingMesh->getVerticesData(::com::gamestudiohx::babylonhx::mesh::VertexBuffer_obj::PositionKind);		HX_STACK_VAR(data,"data");
		HX_STACK_LINE(91)
		if (((data != null()))){
			...
			HX_STACK_LINE(92)
			{
				...
				struct _Function_3_1{
					inline static Dynamic Block( ::com::gamestudiohx::babylonhx::tools::math::Vector3 &minimum,::com::gamestudiohx::babylonhx::tools::math::Vector3 &maximum){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",92,0x2e02d060)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("minimum") , minimum,false);
							__result->Add(HX_CSTRING("maximum") , maximum,false);
...
bool SubMesh_obj::_checkCollision( ::com::gamestudiohx::babylonhx::collisions::Collider collider){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","_checkCollision",0x324c8cd9,"com.gamestudiohx.babylonhx.mesh.SubMesh._checkCollision","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",98,0x2e02d060)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","updateBoundingInfo",0x292cb9eb,"com.gamestudiohx.babylonhx.mesh.SubMesh.updateBoundingInfo","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",102,0x2e02d060)
		HX_STACK_THIS(this)
...
bool SubMesh_obj::isInFrustrum( Array< ::Dynamic > frustumPlanes){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","isInFrustrum",0xdaa600df,"com.gamestudiohx.babylonhx.mesh.SubMesh.isInFrustrum","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",106,0x2e02d060)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","render",0x20fb33a6,"com.gamestudiohx.babylonhx.mesh.SubMesh.render","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",110,0x2e02d060)
		HX_STACK_THIS(this)
		HX_STACK_LINE(110)
...
::com::gamestudiohx::babylonhx::mesh::BabylonGLBuffer SubMesh_obj::getLinesIndexBuffer( Array< int > indices,::com::gamestudiohx::babylonhx::Engine engine){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","getLinesIndexBuffer",0xc0ca2059,"com.gamestudiohx.babylonhx.mesh.SubMesh.getLinesIndexBuffer","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",113,0x2e02d060)
	HX_STACK_THIS(this)
...
bool SubMesh_obj::canIntersects( ::com::gamestudiohx::babylonhx::tools::math::Ray ray){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","canIntersects",0xd662d094,"com.gamestudiohx.babylonhx.mesh.SubMesh.canIntersects","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",136,0x2e02d060)
	HX_STACK_THIS(this)
...
bool fastCheck = __o_fastCheck.Default(false);
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","intersects",0xf04ff304,"com.gamestudiohx.babylonhx.mesh.SubMesh.intersects","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",139,0x2e02d060)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ray,"ray")
...
::com::gamestudiohx::babylonhx::mesh::SubMesh SubMesh_obj::clone( ::com::gamestudiohx::babylonhx::mesh::AbstractMesh newMesh,::com::gamestudiohx::babylonhx::mesh::Mesh newRenderingMesh){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","clone",0xc10cc50d,"com.gamestudiohx.babylonhx.mesh.SubMesh.clone","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",175,0x2e02d060)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","dispose",0xf709fe4f,"com.gamestudiohx.babylonhx.mesh.SubMesh.dispose","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",183,0x2e02d060)
		HX_STACK_THIS(this)
		HX_STACK_LINE(184)
		if (((this->_linesIndexBuffer != null()))){
			HX_STACK_LINE(185)
...
::com::gamestudiohx::babylonhx::mesh::SubMesh SubMesh_obj::CreateFromIndices( int materialIndex,int startIndex,int indexCount,::com::gamestudiohx::babylonhx::mesh::AbstractMesh mesh){
	HX_STACK_FRAME("com.gamestudiohx.babylonhx.mesh.SubMesh","CreateFromIndices",0xcd00bed1,"com.gamestudiohx.babylonhx.mesh.SubMesh.CreateFromIndices","com/gamestudiohx/babylonhx/mesh/SubMesh.hx",194,0x2e02d060)
	HX_STACK_ARG(materialIndex,"materialIndex")
