...
{
HX_STACK_FRAME("Main","new",0x6616a5cb,"Main.new","Main.hx",161,0x087e5c05)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(162)
	super::__construct();
...
Void Main_obj::init( ){
{
		...
		HX_STACK_LINE(125)
		::com::gamestudiohx::babylonhx::mesh::Mesh clouds2 = hx::TCast< ::com::gamestudiohx::babylonhx::mesh::Mesh >::cast(clouds->clone(HX_CSTRING("Clouds"),null(),null()));		HX_STACK_VAR(clouds2,"clouds2");
		HX_STACK_LINE(126)
		clouds2->position->z = (int)-500;

		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_1_4,Array< ::Dynamic >,scene,Array< ::Dynamic >,engine)
		Void run(){
			HX_STACK_FRAME("*","_Function_1_4",0x5200ed3a,"*._Function_1_4","Main.hx",135,0x087e5c05)
			{
				HX_STACK_LINE(135)
...
{
		HX_STACK_FRAME("Main","added",0x98771aeb,"Main.added","Main.hx",166,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(167)
...
Void Main_obj::main( ){
{
		HX_STACK_FRAME("Main","main",0xed0e206e,"Main.main","Main.hx",176,0x087e5c05)
		HX_STACK_LINE(178)
...
Dynamic destroy = __o_destroy.Default(true);
	HX_STACK_FRAME("Main","safeDestroy",0x4e168398,"Main.safeDestroy","Main.hx",183,0x087e5c05)
			...
			while((true)){
					...
					HX_STACK_CATCHABLE(Dynamic, 0);
					{
					...
					catch(Dynamic __e){
						{
							...
							Dynamic e = __e;{
								...
								HX_STACK_LINE(190)
								::haxe::Log_obj::trace(_g5,hx::SourceInfo(HX_CSTRING("Main.hx"),190,HX_CSTRING("Main"),HX_CSTRING("safeDestroy")));
							}
						}
					}
				}
				...
				HX_STACK_CATCHABLE(Dynamic, 0);
				{
				...
				catch(Dynamic __e){
					{
						...
						Dynamic e = __e;{
							HX_STACK_LINE(192)
							::haxe::Log_obj::trace(e,hx::SourceInfo(HX_CSTRING("Main.hx"),192,HX_CSTRING("Main"),HX_CSTRING("safeDestroy")));
						}
					}
				}
				HX_STACK_LINE(193)
...
bool Main_obj::safeRemove( Dynamic obj){
	HX_STACK_FRAME("Main","safeRemove",0x51a28366,"Main.safeRemove","Main.hx",199,0x087e5c05)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(199)
